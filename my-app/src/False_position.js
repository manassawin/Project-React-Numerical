...
export default function False_position() {
  ...
  return (
    ...
    <h1 style={{color: "goldenrod"}}>False_position</h1>
    ...
    <h2 style={{color: "goldenrod"}}><input placeholder="Input XR" type="number" value={xr2} onChange={e=> setxr2(e.target.value)}/></h2>
    <h2 style={{color: "goldenrod"}}><input placeholder="Input XL" type="number" value={xl2} onChange={e=> setxl2(e.target.value)}/></h2><br/>
