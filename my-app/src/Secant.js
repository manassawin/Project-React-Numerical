...
export default function Secant() {
  ...
  return (
    ...
    <h1 style={{color: "goldenrod"}}>Secant</h1>
    ...
    <h2 style={{color: "goldenrod"}}><input placeholder="Input XOLD" type="number" value={x} onChange={e=> setx(e.target.value)}/></h2>
    <h2 style={{color: "goldenrod"}}><input placeholder="Input X" type="number" value={x2} onChange={e=> setx2(e.target.value)}/></h2><br/>
