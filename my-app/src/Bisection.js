...
console.log(xm,err)
  ...
  return (
    ...
    <h1 style={{color: "goldenrod"}}>Bisection Method</h1>
    ...
    <h2 style={{color: "goldenrod"}}><input placeholder="Input XR" type="number" value={xr} onChange={e=> setxr(e.target.value)}/></h2>
    <h2 style={{color: "goldenrod"}}><input placeholder="Input XL" type="number" value={xl} onChange={e=> setxl(e.target.value)}/></h2><br/>
    <Button variant="outline-warning" onClick={e=>cal_result()}> Result</Button> &nbsp; &nbsp;<Button variant="outline-warning" onClick={api}> API</Button><br/><br/>
   
    <center> <Chart options={options} series={series} width={700}height={320}/> </center>
